  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <Box sx={{ padding: 4, maxWidth: '600px' }}>
        ...
        <ul>
          <li>
            **AWB List:** Navigate to the "AWB List" Navbar section to view a list of all your waybills. This list might include filters or sorting options to help you find specific shipments.
          </li>
          <li>
